...
public class Validation {
	...
	static final Identifier.Validator SSN_VALID = g -> {
		...
		int wsum = (2 * ssn6[0] + 3 * ssn6[1] + 4 * ssn6[2] + 5 * ssn6[3] + 6 * ssn6[4] + 7 * ssn6[5] + 8 * ssn7[0]
				+ 9 * ssn7[1] + 2 * ssn7[2] + 3 * ssn7[3] + 4 * ssn7[4] + 5 * ssn7[5]);
	...
	static final Identifier.Validator HIN_VALID = g -> {
		...
		int wsum = (hin[0] * 3 + hin[1] * 5 + hin[2] * 7 + hin[3] * 9 + hin[4] * 3 + hin[5] * 5 + hin[6] * 7
				+ hin[7] * 9 + hin[8] * 3 + hin[9] * 5) % 11;
	...
	public static void main(String[] args) throws IOException {
		...
		while (true) {
...

			{
				...
				new Validation().validate(fromClient, "UTF-8");
				...
				String sendDataString = String.valueOf(-1);
